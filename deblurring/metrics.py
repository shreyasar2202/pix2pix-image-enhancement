...
def psnr(original, generated):
    ...
    original = (original.detach().permute(0, 2, 3, 1) * 0.25 + 0.5) \
        * 255
    generated = (generated.detach().permute(0, 2, 3, 1) * 0.25 + 0.5) \
        * 255
...
def ssim(original, generated):
    ...
    for i in range(original.shape[0]):
        total_ssim += np.mean(sewar.ssim(original[i], generated[i],
                              MAX=255))
